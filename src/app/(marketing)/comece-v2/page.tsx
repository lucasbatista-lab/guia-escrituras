    ...
    <div className="min-h-screen bg-sand-50 pb-[calc(4.5rem+var(--safe-bottom))] md:pb-0">
      ...
      <main id="conteudo-principal" tabIndex={-1} className="outline-none">
        ...
        >
          ...
          <div className="relative mx-auto grid max-w-6xl gap-4 px-4 pb-5 pt-1 sm:gap-7 sm:px-6 sm:pb-10 sm:pt-3 lg:grid-cols-[minmax(0,0.4fr)_minmax(0,0.6fr)] lg:items-center lg:gap-10 lg:pb-14 lg:pt-5">
            <div className="min-w-0 animate-fade-up text-left">
              ...
              <h1
                ...
                className="mt-2 max-w-[17ch] text-balance font-display text-[clamp(2.15rem,9vw,2.75rem)] leading-[1.02] tracking-tight text-ink sm:max-w-none sm:text-[3.25rem] sm:leading-[1.04] lg:text-[4.35rem] lg:leading-[1.02]"
              >
                Organize o que está pesando. Enxergue um próximo passo à luz
                das Escrituras.
              </h1>
              <p className="mt-2.5 hidden max-w-md text-[1.02rem] leading-snug text-ink-soft sm:mt-3.5 sm:block sm:max-w-lg sm:text-[1.08rem] sm:leading-relaxed">
                Conte sua situação. O Amém Chat faz perguntas, separa o que
                está em jogo e traz referências bíblicas para você refletir com
                responsabilidade.
              </p>
              <p className="mt-2.5 max-w-md text-[0.98rem] leading-snug text-ink-soft sm:hidden">
                Conte sua situação. Perguntas, referências bíblicas e um próximo
                passo possível — com responsabilidade.
              </p>

              <div className="mt-3.5 flex flex-col items-stretch gap-2 sm:mt-5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
                <Button
                  asChild
                  size="lg"
              ...
              <p className="mt-2 text-[0.8rem] leading-snug text-ink-soft sm:mt-3 sm:text-sm">
                A partir de R$38/mês. Cobrança mensal. Cancele pela Conta.
                <span className="text-ink-soft/90"> · Conversas privadas.</span>
              </p>
            </div>
            ...
            <div className="relative min-w-0 animate-fade-up-delayed">
              ...
              />
              <div className="relative max-h-[min(48vh,22rem)] overflow-hidden sm:max-h-none lg:translate-x-2 lg:scale-[1.04]">
                <PaidLandingV2Media
                  priority
                ...
                <div
                  aria-hidden
                  className="pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-sand-50 to-transparent sm:hidden"
                />
              </div>
            </div>
          </div>
