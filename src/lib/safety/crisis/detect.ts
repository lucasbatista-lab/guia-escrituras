...
const SIGNALS: Signal[] = [
  {
    ...
    any: [
      ...
      /\btirar minha vida\b/,
      /\b(penso|pensando|pensei) em tirar (a )?minha vida\b/,
      /\bacabar com a minha vida\b/,
      /\bacabar com minha vida\b/,
      /\bquero acabar com (a )?minha vida\b/,
      /\bquero morrer\b/,
      /\bvou me matar\b/,
      /\bme matar\b/,
      ...
      /\bnao continuar vivo\b/,
      /\bnao quero continuar vivo\b/,
      /\bsem vontade de viver\b/,
      /\bnao vejo saida\b.{0,40}\b(viver|vida|morrer)/,
      /\bpensar em morrer\b/,
      /\bquero desaparecer para sempre\b/,
    ...
    unless: [
      ...
      // Fiction / third-person narrative — not personal ideation.
      /\bpersonagem\b/,
      /\bno (livro|filme|serie|romance)\b/,
      // Situational “vivendo desse jeito” (job/life change), not ending life.
      /\bcontinuar vivendo desse jeito\b/,
      /\bnao quero continuar vivendo desse\b/,
    ],
  },
  {
    id: "suicide_safety_now",
    category: "suicide",
    any: [
      /\bnao (consigo|sei se consigo) me manter segur[oa]\b/,
      /\bnao consigo me manter segur[oa]\b/,
      /\btenho um plano para me (ferir|matar|cortar|machucar)\b/,
      /\bestou pensando seriamente em nao continuar vivo\b/,
    ],
    unless: [
      /\bpersonagem\b/,
      /\bno (livro|filme|serie|romance)\b/,
  ...
  },
  {
    ...
    unless: [
      /\bsem (pensar|pensando) em me (machucar|ferir|cortar)\b/,
      /\bnao (quero|vou|penso|estou pensando) me (machucar|ferir|cortar)\b/,
      /\bsem (intencao|desejo) de me (machucar|ferir)\b/,
    ],
  },
  {
